  ...
  return (
    <div className="w-full max-w-[800px] space-y-12">
      ...
      <div className="animate-fade-in-down space-y-8 text-center">
        {/* Main Headline */}
        <h1 className="bg-gradient-to-r from-white via-red-100 to-red-300 bg-clip-text font-sans text-6xl font-bold leading-tight text-transparent">
      ...
      <div className="animate-stagger-fade-in z-10 flex flex-wrap items-center justify-center gap-4">
        <div className="group flex items-center gap-2 rounded-full border border-gray-700/50 bg-gray-800/50 px-4 py-2 backdrop-blur-sm transition-all hover:-translate-y-1 hover:border-red-500/50 hover:shadow-lg hover:shadow-red-500/20">
      ...
      <div className="animate-scale-in space-y-6">
        <div className="relative">
          <Search className="absolute left-6 top-1/2 h-6 w-6 -translate-y-1/2 text-red-500 transition-all" />
          <Input
            type="text"
            ...
            className="h-16 rounded-2xl border-2 border-gray-700/50 bg-gray-900/40 pl-16 pr-6 font-sans text-lg text-white shadow-inner backdrop-blur-lg placeholder:text-gray-500 transition-all duration-300 focus:scale-[1.02] focus:border-red-500 focus:shadow-lg focus:shadow-red-500/30 focus:ring-0"
          />
        </div>
      ...
      <div className="flex min-h-[140px] flex-col items-center justify-center">
        {isLoading && (
          <div className="flex flex-col items-center gap-4">
            <SegmentedRingLoader />
            <p className="animate-pulse font-mono text-sm text-red-400">Analyzing sentiment...</p>
          </div>
        )}

        {isComplete && !isLoading && (
          <div className="animate-pulse">
            <p className="font-sans text-lg font-medium text-red-500">✅ Analysis Complete</p>
          </div>
        )}
