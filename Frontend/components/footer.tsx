    ...
    <footer className="border-t border-gray-800 bg-black">
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="flex flex-col items-center gap-4 text-center">
          {/* Copyright */}
          <p className="font-sans text-sm text-gray-400">© 2025 StockNews. All rights reserved.</p>
          ...
          <div className="mt-4 h-1 w-24 rounded-full bg-gradient-to-r from-red-500 to-red-600" />
        </div>
      </div>
    </footer>
  )
